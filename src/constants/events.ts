...
export const events: readonly Event[] = [
  ...
  },
  {
    ...
    registrationFee: 1000,
    rules: [
      "Prelims: Icebreaker round—introduce your college and university in a fun, innovative way.",
      "Final round will be traditional Mad Ads format.",
      "One narrator is mandatory, primarily in English, with a touch of vernacular for humor.",
      "No vulgarity, offensive content, instruments, background music, or props.",
      "Unique and uniform costumes earn brownie points (must follow the college dress code).",
      "Additional rounds may be introduced at the judges' discretion.",
    ],
    capacity: "5-8 members",
    timeLimit: "3+2 minutes(Icebreaker round)",
    open: false,
    cashPrize: 5000,
  ...
  },
  {
    ...
    capacity: "Individial participation",
